...
export default {
    ...
    created(){
        if (this.AbmAccion != 'agregar'){
            this.traerDatosPorId('articulos', this.AbmId)
               .then(respuesta=>{
    ...
    methods:{
        aceptar(){
            if (this.AbmAccion == 'agregar'){
                this.insertarDatosApi('articulos', this.datos)
                 .then(respuesta => {
            ...
            if (this.AbmAccion == 'editar'){
                this.EditarDatosApi('articulos', this.AbmId, this.datos)
                .then(respuesta=> {
                    this.$emit('salirDeAbmArticulos', true)
                    this.datos = respuesta
                })
            ...
            if (this.AbmAccion =='eliminar'){
                this.EliminarDatosApi('articulos', this.AbmId)
                .then(respuesta=>{
                    this.$emit('salirDeAbmArticulos', true)
                    this.datos = respuesta
                })
